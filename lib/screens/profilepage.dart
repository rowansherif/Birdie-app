              ...
              children: [
                      ...
                      Container( 
                       ...
                       Container( 
                        ...
                        ElevatedButton(onPressed:() {
                             ...
                             child: Text("GPS Tracking History",
                             style: TextStyle(fontSize: 15,color: Colors.black),
                                    ),
                                style: ButtonStyle(
                                  backgroundColor: MaterialStateProperty.all(Colors.white),
                                  padding: MaterialStateProperty.all(EdgeInsets.only(left: 20, right: 205,top: 20,bottom: 15)),
                      ...
                      SizedBox(height: 30,),
                        ...
                        ElevatedButton(onPressed:() {
                             ...
                             style: TextStyle(fontSize: 15,color: Colors.black),
                                ...
                                style: ButtonStyle(
                                  backgroundColor: MaterialStateProperty.all(Colors.white),
                                  padding: MaterialStateProperty.all(EdgeInsets.symmetric(horizontal: 70, vertical: 16)),
                                  shape: MaterialStateProperty.all(RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(10),
                               ),
                            ),
                ...
                Positioned(
                  ...
                  child: Container(
                    height: 170,
                    width: 170,
                    child: Image(image: AssetImage('assets/User-Profile.png'),),
                  ),
                ),
              ]
            ),
